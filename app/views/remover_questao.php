...
<head>
    <title>Remover Questão - BattleStudy</title>
            ...
            <div id="total" class="row">
                <form action="../logic/questao.php" method="post">
                    <div class="col l12 s12 m12 input-field">
                        <input placeholder="Digite o id questão" name="id_questao" type="text" class="validate" maxlength="250" required>
                        <label for="bbb">ID Questão</label>
                    </div>
                    <div class="col l12 s12 m12 input-field">
                        <button class="btn waves-effect waves-light grey darken-4" type="submit" name="botao" value="Remover">Remover</button>
                    </div>
                </form>
            </div>
        </div>
