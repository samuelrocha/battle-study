...
<head>
    <title>Cadastrar Organização - BattleStudy</title>
    ...
    <div class="row container conteudo">
        <div class="col l12 s12 m12">
            <div id="total" class="row">
                <form action="../logic/organizacao.php" method="post">
                    <div class="col l12 s12 m12 input-field">
                        <input placeholder="Digite a organização" name="nome" type="text" class="validate"  maxlength="40" required>
                        <label for="bbb">Organização</label>
                    </div>
                    <div class="col l12 s12 m12 input-field">
                        <button class="btn waves-effect waves-light grey darken-4" type="submit" name="botao" value="Cadastrar">Cadastrar</button>
                    </div>
                </form>
            </div>
        </div>
