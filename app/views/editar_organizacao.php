...
<head>
    <title>Editar Organização - BattleStudy</title>
            ...
            <div id="total" class="row">
                <form action="../logic/organizacao.php" method="post">
                    <div class="col l12 s12 m12 input-field">
                        <input placeholder="Digite o id organização" name="id_organizacao" type="text" class="validate" maxlength="250" required>
                        <label for="bbb">ID Organização</label>
                    </div>
                    <div class="col l12 s12 m12 input-field">
